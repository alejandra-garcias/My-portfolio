...
import style from "../[id]/page.scss";
    ...
    <div className="contenedor-page">
      ...
      <div className="contenedor-fotosbotones">
        ...
        <div className="contenedor-botones">
          <a href={project.urlGithub}><button className="button">Github </button></a>
          <a href={project.urlSite}><button className="button">Go to site </button></a>
        </div>
      </div>
    </div>
  );
